        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 7, 5, 15, 32, 50, 287, DateTimeKind.Local).AddTicks(3576)),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryStranlations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CategoryStranlations_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryStranlations_Languages_LanguageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryStranlations_CategoryId",
                table: "CategoryStranlations",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoryStranlations_LanguageId",
                table: "CategoryStranlations",
                column: "LanguageId");
